            ...
            <div class="text tovar">
              {PAGE_CONTENT}
					...
					<div class="box closeWindow" id="basketBox">
						<div class="head"><a href="#">свернуть</a></div>
						<div class="main">
							<div class="border">
								<form action="#" method="get" id="basketForm">
									<div>
										<h2>корзина</h2>
										<a href="#" class="arrows up">вверх</a>
										<div id="basket" class="scrollBox">
											<table>
												<tr>
													...
													<td href="/img/catalog_img.jpg" class="second">Жалюзи БРАВО</td>
													<td class="third"><span>768.69</span>грн</td>
												...
												<tr>
													...
													<td href="/img/rec_img1.jpg" class="second">Жалюзи БРАВО Необыкновенные</td>
													<td class="third"><span>768.69</span>грн</td>
													<td class="fourth"><a class="delete" title="Удалить товар" href="#">x</a></td>
												</tr>
												<tr>
													...
													<td href="/img/rec_img2.jpg" class="second">Жалюзи ТОРПЕДА</td>
													<td class="third"><span>768.69</span>грн</td>
													<td class="fourth"><a class="delete" title="Удалить товар" href="#">x</a></td>
												</tr>
												<tr>
										...
										<p class="all">Всего:<span>0 товар(ов)</span></p>
										<p class="summ">Сумма:<span>0грн</span></p>
										<button id="save">Сохранить</button>
										<input type="submit" id="basket-sub" value="Оформить заказ" />
									</div>
								</form>
							</div>
						</div>
  ...
  <div id="footer">
    <div id="copyright">
      ...
      <p>© все права защищены</p>
			...
			<!--bigmir)net TOP 100-->
			<a href="http://welitta.com" alt="продвижение сайтов" target="_blank" class="welitta">продвижение сайтов  Welitta</a>
    </div>
  </div>
</body>
</html>