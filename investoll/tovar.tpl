...
<div class="page">
	...
	<div class="right_col">
		...
		<div class="fla">
			<div class="lang"> 
				<ul>
					<li class="curlang"><a href="#">ru</a></li>
					<li><a href="#">de</a></li>
					<li><a href="#">eng</a></li>
					<li><a href="#">ukr</a></li>
				</ul>
		...
		<div class="padr">
			<div class="right-part-wrapper">
				<div class="right_part" id="rightPart">
					<div class="plfon">&nbsp;</div>
					<div class="box">
						<div class="padrr">
							...
							<ul>
								<li><a href="#">Окна</a></li>
								<li><a href="#">REHAU</a></li>
								<li><a href="#">Одинарные</a></li>
								<li class="curpos"><a href="#">REHAU 32A</a></li>
							</ul>
							<span class="orange" style="text-transform:uppercase;">{PAGE_DESC}</span>
							<div class="clear_medium"></div>
						</div>
						<div class="padrr2 large tovar">
							<div class="tovar-descr-wrapper">
								<div class="tovar-descr">
									<h3>Окна REHAU 32A</h3>
									<table>
										<tr class="blue">
											<td class="big">Размеры(мм):</td>
											<td>2275 х 2000 х 2260</td>
										</tr>
										<tr>
											<td>Вес:</td>
											<td>130 кг</td>
										...
										<tr><td colspan="2"></tr>
										<tr class="blue"><td colspan="2"></tr>
									</table>
									<div class="tovar-links">
										<a href="#" class="description curlink"><span>Описание</span></a>
										<a href="#" class="rec"><span>Рекомендуем</span></a>
									</div>
									<p>Жалюзи нужно открывать правой рукой, потому что левой они просто не откроются. Но при этом Жалюзи нужно открывать правой рукой, потому что левой они просто не откроются. Но при этом ...</p>
									<p>Жалюзи нужно открывать правой рукой, потому что левой они просто не откроются. Но при этом Жалюзи нужно открывать правой рукой, потому что левой они просто не откроются. Но при этом ...</p>
									<p>Жалюзи нужно открывать правой рукой, потому что левой они просто не откроются. Но при этом Жалюзи нужно открывать правой рукой, потому что левой они просто не откроются. Но при этом ...</p>
								</div>
							</div>
							<div class="tovar-left">
								<div class="tovar-image">
									<img src="/img/imgae_tovar.jpg" alt="" />
									<a href="#">Все фотографии</a>
								</div>
								<div class="clear2"></div>
								<div class="tovar-basket">
									<p class="tovar-price"><strong>386<b>грн</b></strong> <span>520<b>грн</b></span></p>
									<a href="#" class="addbasket">добавить в корзину</a>
									<a href="#" class="tovar-more">Подробнее</a>
								</div>
							</div>
         				</div>
					</div>
			...
			<div id="smDouknow">
				<a href="#">р<br />а<br />з<br />в<br />е<br />р<br />н<br />у<br />т<br />ь</a>
			</div>
